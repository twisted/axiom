...
class GeneratedDataTests(TestCase):
    ...
    """
    @given(st.builds(Store), axiom_text() | st.none())
    ...
    @given(st.builds(Store), axiom_integers() | st.none())
    ...
    @given(st.builds(Store),
           axiom_integers().map(lambda d: d * Decimal('0.1')) | st.none())
    ...
    @given(st.builds(Store),
           axiom_integers().map(lambda d: d * Decimal('0.0001')) | st.none())
